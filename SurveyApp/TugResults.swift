...
struct TUGResults: View {
    ...
    var body: some View {
        ScrollView{
        VStack{
            Text("TUG Test Results").font(.system(size: 60)).multilineTextAlignment(.center).fixedSize(horizontal: false, vertical: true)
            
            Spacer().frame(height: 30)
            
            Text("The patient is \(self.intAge) years old and completed TUG Test in \(self.intStands) seconds. \(TUGLogic(age: intAge, stands: intStands, gen: self.gender))").font(.system(size: 36)).multilineTextAlignment(.center).fixedSize(horizontal: false, vertical: true)
        ...
        Spacer()
            ...
            if self.TugTime != "" {self.intStands = Int(self.TugTime)!}
        })
    }
    }
}
...
//
//            //
//           // Text(TUGResults(age: TugTime)).font(.system(size: 36)).multilineTextAlignment(.center)
//
//            Spacer().frame(height: 30)
//
//            HStack{
